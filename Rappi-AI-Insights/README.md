...
![Average Order Cost by Zone](data/plots/average_order_cost_by_zone.png)

### 2) Average Fee Share (% of Total)
![Average Fee Share (% of Total)](data/plots/average_fee_share_pct.png)

### 3) Fee Composition by Platform
![Fee Composition by Platform](data/plots/fee_composition_by_platform.png)

### 4) Cost per Minute (Price vs Delivery Time)
![Cost per Minute (Price vs Delivery Time)](data/plots/cost_per_minute_by_zone.png)
